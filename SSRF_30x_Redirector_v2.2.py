                ...
                <div id="tab-blindbench" class="tab-content">
                    ...
                    <div class="bypass-panel" style="border-color:rgba(57,213,255,0.3);margin-bottom:18px;">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;flex-wrap:wrap;gap:8px;">
                            <h3 style="font-size:14px;color:var(--accent-cyan);">🧰 环境仿真模板库 (<span id="bbTplTotal">0</span>)</h3>
                            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                                <button class="btn btn-cyan btn-small" onclick="bbTplDeployAll()">⚡ 一键部署全部</button>
                                <button class="manual-refresh-btn" onclick="loadBbTemplates()">🔄 刷新</button>
                            </div>
                        </div>
...
def run_startup_wizard():
    ...
    print('=' * 62)
    print('  ⚡ SSRF 30x Redirector v2.2 · 启动配置向导')
    print('=' * 62)
...
if __name__ == '__main__':
    ...
    print(f"\n{'=' * 62}")
    print(f"🚀 SSRF 实战 30x Redirector 引擎启动成功 (v2.2)")
    print(f"{'=' * 62}")
