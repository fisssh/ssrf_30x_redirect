...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>云原生穿透引擎 · K8s/Docker 307无损引流 · Gopher封装 · 批量队列投递 · Burp风格编辑器 · 全局高级请求编辑</p>
        </div>
        <div class="stats">
    ...
    <script>
        ...
        function rawToGopher(rawAreaId, targetInputId) {
            ...
            // Build raw request with \\r\\n
            let rawRequest = rawText.replace(/\\r?\\n/g, '\\r\\n');
            if (!rawRequest.endsWith('\\r\\n')) rawRequest += '\\r\\n';
            
            // Recalculate Content-Length if there's a body
